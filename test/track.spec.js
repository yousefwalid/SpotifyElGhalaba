...
//     };
//     const track = await TrackController.createTrackLogic(trackObj, currentUser);
//     const currenttrack = await Track.findOne({
//       name: 'testTrack'
//     });
...
//       name: 'testTrack'
//     });
//     const result = await TrackController.getTrackLogic(track._id);
...
//     await album.save();
//     console.log(album);
//     const result = await TrackController.removeTrackLogic(track._id);
//   });
// });
